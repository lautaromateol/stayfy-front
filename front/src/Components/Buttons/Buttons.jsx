...
const Buttons = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center">
            <div className="text-4xl font-medium text-stone-600 bg-gray-200 w-screen py-3 mb-5 shadow-2xl shadow-gray-400 dark:bg-gray-900 py-10 px-12 dark:text-gray-100 dark:shadow-transparent dark:border-b-2 dark:border-gray-600">Genres</div>
            <div className="grid grid-cols-[33%_33%_33%] gap-10">
