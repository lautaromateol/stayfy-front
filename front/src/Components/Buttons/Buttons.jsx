...
const Buttons = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center">
            <div className="text-4xl font-bold text-stone-600 bg-gray-200 w-full py-3 mb-5 shadow-2xl shadow-gray-400 dark:bg-gray-900 px-12 dark:text-gray-100 dark:shadow-transparent dark:border-b-2 dark:border-gray-600">Genres</div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10" data-aos = 'fade-up'>
                ...
                <button onClick={()=>handleNavigation("Self-help")}>
                ...
                <button onClick={()=>handleNavigation("Sci-Fi")}>
                ...
                <button onClick={()=>handleNavigation("Romance")}>
                ...
                <button onClick={()=>handleNavigation("Mystery & Detective")}>
                ...
                <button onClick={()=>handleNavigation("Comedy")}>
